...
export class RunnerDirective implements AfterViewInit {

    _id: string = "editor";
    _mode: string = "cql";
    _theme: string = "monokai";
    _value: string = "// Enter your CQL script here and press 'Run'\n// The results are displayed in the console to the right\n";
    _lineNumbers: boolean = true;
    _readOnly: boolean = false;
    _ruler: any = [{color: "#efefef", column: 70, lineStyle: "solid"}];
    _styleActiveLine: boolean = true;
